                ...
                <section id="xw5fsxr" className="w-full relative overflow-scroll ">
                    ...
                    <div className="w-full h-128 bg-contain bg-no-repeat bg-gradient-to-r from-[#010828] to-[#1e2f62] flex justify-center items-center md:justify-start">
                        ...
                        <nav className="flex justify-between items-center p-5 md:px-12 absolute w-full top-0 border-b backdrop-blur-xs">
                            ...
                            <button id="nav_cta" className="hidden bg-white text-black font-medium text-md p-2 px-4 rounded-lg md:block">Contact Us</button>
                            <button id="nav_mob" className="md:hidden"><svg xmlns="http://www.w3.org/2000/svg" height="48px" viewBox="0 -960 960 960" width="48px" fill="#FFF" className="size-6"><path d="M150-240q-12.75 0-21.37-8.68-8.63-8.67-8.63-21.5 0-12.82 8.63-21.32 8.62-8.5 21.37-8.5h660q12.75 0 21.38 8.68 8.62 8.67 8.62 21.5 0 12.82-8.62 21.32-8.63 8.5-21.38 8.5H150Zm0-210q-12.75 0-21.37-8.68-8.63-8.67-8.63-21.5 0-12.82 8.63-21.32 8.62-8.5 21.37-8.5h660q12.75 0 21.38 8.68 8.62 8.67 8.62 21.5 0 12.82-8.62 21.32-8.63 8.5-21.38 8.5H150Zm0-210q-12.75 0-21.37-8.68-8.63-8.67-8.63-21.5 0-12.82 8.63-21.32 8.62-8.5 21.37-8.5h660q12.75 0 21.38 8.68 8.62 8.67 8.62 21.5 0 12.82-8.62 21.32-8.63 8.5-21.38 8.5H150Z"/></svg></button>
                        </nav>

                        <div className="p-8 md:p-12 flex flex-col text-center gap-2 relative md:w-1/2 mx-auto md:mx-0 md:text-left md:mt-16">
                            <h1 className="capitalize text-white font-medium text-xl ubuntu md:text-5xl leading-tight mb-2">Rediscover the joy of open road.</h1>
                            <p className="roboto text-xs md:text-sm">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.</p>
                            <section className="flex gap-2 w-fit mx-auto md:mx-0 border border-solid border-white rounded bg-white/20 p-2 px-2 mt-4 backdrop-blur-xs">
                                <input type="text" className="text-xs placeholder:text-gray-100" placeholder="Search model name ..." />
                                <button className=""><svg xmlns="http://www.w3.org/2000/svg" height="48px" viewBox="0 -960 960 960" width="48px" fill="#FFF" className="size-3 md:size-4"><path d="M378-329q-108.16 0-183.08-75Q120-479 120-585t75-181q75-75 181.5-75t181 75Q632-691 632-584.85 632-542 618-502q-14 40-42 75l242 240q9 8.56 9 21.78T818-143q-9 9-22.22 9-13.22 0-21.78-9L533-384q-30 26-69.96 40.5Q423.08-329 378-329Zm-1-60q81.25 0 138.13-57.5Q572-504 572-585t-56.87-138.5Q458.25-781 377-781q-82.08 0-139.54 57.5Q180-666 180-585t57.46 138.5Q294.92-389 377-389Z"/></svg></button>
                            </section>
                        </div>

                        <div className="h-6 w-full absolute bottom-50 bg-gradient-to-r from-[#010828] to-[#1e2f62] hidden"></div>
                    </div>
